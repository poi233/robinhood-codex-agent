...
OVERRIDE_DSA_MAX_WORKERS="${DSA_MAX_WORKERS-}"
OVERRIDE_DSA_BATCH_SIZE="${DSA_BATCH_SIZE-}"
...
[[ -n "$OVERRIDE_DSA_MAX_WORKERS" ]] && DSA_MAX_WORKERS="$OVERRIDE_DSA_MAX_WORKERS"
[[ -n "$OVERRIDE_DSA_BATCH_SIZE" ]] && DSA_BATCH_SIZE="$OVERRIDE_DSA_BATCH_SIZE"
...
DSA_MAX_WORKERS="${DSA_MAX_WORKERS:-4}"
DSA_BATCH_SIZE="${DSA_BATCH_SIZE:-8}"
...
export DSA_MAX_WORKERS
export DSA_BATCH_SIZE
...
DSA_MAX_WORKERS=$DSA_MAX_WORKERS
DSA_BATCH_SIZE=$DSA_BATCH_SIZE
