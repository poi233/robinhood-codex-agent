...
# ENABLE_WEEKLY_SCREENER=1 — auto-updates the universe ADD-ONLY (never deletes) + re-ranks, capped
...
log_line "weekly screener starting (date=$RUN_DATE_PT, ENABLE_WEEKLY_SCREENER=${ENABLE_WEEKLY_SCREENER:-0})"
