...
def build_runtime_block(run_kind: str, agent_root: Path, *, overrides: Mapping[str, str] | None = None) -> str:
    ...
    values = {
        ...
        "DSA_MAX_SUBAGENTS": env.get("DSA_MAX_SUBAGENTS", "3"),
        "TECHNICAL_MAX_SUBAGENTS": env.get("TECHNICAL_MAX_SUBAGENTS", "3"),
        ...
        "ENABLE_TECHNICAL_FEATURES_PRECOMPUTE": env.get("ENABLE_TECHNICAL_FEATURES_PRECOMPUTE", "1"),
        "ENABLE_DSA_METRICS_PRECOMPUTE": env.get("ENABLE_DSA_METRICS_PRECOMPUTE", "1"),
        "TECHNICAL_RECENT_BARS": env.get("TECHNICAL_RECENT_BARS", "30"),
        "DSA_METRICS_LOOKBACK_DAYS": env.get("DSA_METRICS_LOOKBACK_DAYS", "180"),
        "MARKET_FEED_DIR": str(paths.market_feed_dir),
        "DSA_SIGNALS_PATH": str(paths.dsa_signals_path),
        "DSA_METRICS_PATH": str(paths.dsa_metrics_path),
        "KRONOS_SIGNALS_PATH": str(paths.kronos_signals_path),
        "TECHNICAL_SIGNALS_PATH": str(paths.technical_signals_path),
        "TECHNICAL_FEATURES_PATH": str(paths.technical_features_path),
        ...
        "DAILY_PLAN_ZH_MARKDOWN_PATH": str(paths.daily_plan_zh_markdown_path),
