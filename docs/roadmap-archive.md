...
> 从 [`roadmap.md`](./roadmap.md) 拆出的**已完成项详细实现记录**（归档于 2026-06-16）。
> 当前/未完成的工作仍在 `roadmap.md`：优先级总表 + D2、E2/E4、F2/F3、H、I 阶段。
> 含：A 全阶段、B1–B4、C 全阶段、D1/D3/D4、E1/E3、F1、G 全阶段（G-pre–G9）、B5。
