...
| **Q 策略发现与多样性引擎**（最大化复用历史数据筛策略，用户新增 2026-06-24，见下方 Q 段） | Q1 | **历史 setup 重放筛选器**（任意 setup × 全历史 → 假设成交/前向收益/样本数表） | 用户新增（2026-06-24） | ⏳ **待开始** |
...
## Q — 策略发现与多样性引擎（最大化复用历史数据筛策略）— ⏳ 规划中（2026-06-24）
