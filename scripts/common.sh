...
[[ -n "$OVERRIDE_TECHNICAL_SIGNALS_FILE" ]] && TECHNICAL_SIGNALS_FILE="$OVERRIDE_TECHNICAL_SIGNALS_FILE"
...
MARKET_FEED_DIR="${MARKET_FEED_DIR:-${AGENT_ROOT}/state/market_feed/$(pt_date)}"
